...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/auth/index1", "/auth/catalog", "/auth/about", "/auth/adr" ,"/error", "/auth/registration", "/product", "/product/info/{id}", "/img/**","/css/**","/js/**", "/product/search").permitAll()
